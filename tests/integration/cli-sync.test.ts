...
`;
    ...
    expect(existsSync('CLAUDE.md')).toBe(true);
    expect(existsSync('.cursor/instructions.md')).toBe(true);

    const claudeContent = readFileSync('CLAUDE.md', 'utf-8');
    const cursorContent = readFileSync('.cursor/instructions.md', 'utf-8');
...
`;
    ...
    expect(existsSync('.cursor/instructions.md')).toBe(true);
    const content = readFileSync('.cursor/instructions.md', 'utf-8');
